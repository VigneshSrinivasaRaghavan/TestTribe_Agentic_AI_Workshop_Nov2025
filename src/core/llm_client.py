# src/core/llm_client.py  (LangChain-backed, drop-in)
...
# Keep your existing env contract (same keys as before)
...
TIMEOUT_S = int(os.getenv("LLM_TIMEOUT_S") or "60")  # advisory for now
LLM_LOG = os.getenv("LLM_LOG","0").strip().lower() in ("1", "true", "yes")
